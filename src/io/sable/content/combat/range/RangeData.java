package io.sable.content.combat.range;

import java.util.*;

import io.sable.content.achievement_diary.DifficultyAchievementDiary;
import io.sable.content.combat.effects.damageeffect.DamageBoostingEffect;
import io.sable.content.combat.effects.damageeffect.impl.bolts.DiamondBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.DragonBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.EmeraldBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.JadeBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.OnyxBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.OpalBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.PearlBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.RubyBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.SapphireBoltSpecial;
import io.sable.content.combat.effects.damageeffect.impl.bolts.TopazBoltSpecial;
import io.sable.content.combat.weapon.RangedWeaponType;
import io.sable.content.skills.herblore.PoisonedWeapon;
import io.sable.model.Bonus;
