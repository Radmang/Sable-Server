...
import io.sable.content.*;
import io.sable.content.achievement.AchievementType;
import io.sable.content.bosses.*;
import io.sable.content.bosses.hespori.Hespori;
import io.sable.content.bosspoints.BossPoints;
import io.sable.content.combat.effects.damageeffect.impl.amuletofthedamned.impl.ToragsEffect;
import io.sable.content.combat.melee.MeleeExtras;
import io.sable.content.combat.weapon.WeaponMode;
import io.sable.content.commands.all.Reclaim;
import io.sable.content.compromised.CompromisedAccounts;
import io.sable.content.dailyrewards.DailyRewards;
import io.sable.content.dialogue.DialogueBuilder;
import io.sable.content.dialogue.DialogueOption;
import io.sable.content.donationrewards.DonationRewards;
import io.sable.content.dwarfmulticannon.Cannon;
import io.sable.content.event.eventcalendar.EventChallengeMonthlyReward;
import io.sable.content.item.lootable.impl.*;
import io.sable.content.items.PvpWeapons;
import io.sable.content.itemskeptondeath.perdu.PerduLostPropertyShop;
import io.sable.content.leaderboards.LeaderboardPeriodicity;
import io.sable.content.leaderboards.LeaderboardUtils;
import io.sable.content.minigames.tob.TobConstants;
import io.sable.content.minigames.tob.TobContainer;
import io.sable.content.minigames.tob.instance.TobInstance;
import io.sable.content.party.PlayerParty;
import io.sable.content.privatemessaging.FriendsList;
import io.sable.content.minigames.raids.Raids;
import io.sable.content.miniquests.magearenaii.MageArenaII;
import io.sable.content.questing.Questing;
import io.sable.content.teleportation.inter.TeleportInterface;
import io.sable.content.tournaments.OutlastLeaderboardEntry;
import io.sable.content.tutorial.ModeSelection;
import io.sable.content.tutorial.TutorialDialogue;
import io.sable.content.wogw.WogwContributeInterface;
import io.sable.model.*;
import io.sable.content.bosses.nightmare.NightmareConstants;
import io.sable.content.combat.core.AttackEntity;
import io.sable.content.combat.EntityDamageQueue;
import io.sable.content.combat.formula.MeleeMaxHit;
import io.sable.content.combat.melee.CombatPrayer;
import io.sable.content.combat.melee.MeleeData;
import io.sable.content.combat.weapon.CombatStyle;
import io.sable.content.miniquests.MageArena;
import io.sable.content.skills.Skill;
import io.sable.content.vote_panel.VotePanelManager;
import io.sable.content.vote_panel.VoteUser;
import io.sable.model.collisionmap.RegionProvider;
import io.sable.model.collisionmap.doors.Location;
import io.sable.model.controller.Controller;
import io.sable.model.controller.ControllerRepository;
import io.sable.model.entity.player.lock.PlayerLock;
import io.sable.model.entity.player.lock.Unlocked;
import io.sable.model.entity.player.migration.PlayerMigrationRepository;
import io.sable.model.entity.player.mode.ModeRevertType;
...
import io.sable.model.entity.player.packets.ChangeAppearance;
import io.sable.model.entity.player.save.PlayerAddresses;
import io.sable.model.items.*;
import io.sable.model.StringInput;
import io.sable.model.multiplayersession.flowerpoker.FlowerPoker;
import io.sable.model.multiplayersession.flowerpoker.FlowerPokerHand;
import io.sable.model.tickable.Tickable;
import io.sable.model.tickable.TickableContainer;
import io.sable.model.definitions.ItemDef;
import io.sable.model.entity.EntityReference;
...
import io.sable.model.timers.TickTimer;
...
import io.sable.model.cycleevent.impl.MinigamePlayersEvent;
import io.sable.model.cycleevent.impl.RunEnergyEvent;
import io.sable.model.cycleevent.impl.SkillRestorationEvent;
import io.sable.content.item.lootable.unref.CoinBagBuldging;
import io.sable.content.achievement.AchievementHandler;
import io.sable.content.achievement.Achievements;
import io.sable.content.achievement_diary.AchievementDiaryManager;
import io.sable.content.achievement_diary.RechargeItems;
import io.sable.content.bosses.godwars.God;
import io.sable.content.bosses.godwars.Godwars;
import io.sable.content.bosses.godwars.GodwarsEquipment;
import io.sable.content.bosses.zulrah.Zulrah;
import io.sable.content.cheatprevention.RandomEventInterface;
import io.sable.content.collection_log.CollectionLog;
import io.sable.content.combat.CombatItems;
import io.sable.content.combat.Hitmark;
import io.sable.content.combat.death.PlayerDeath;
import io.sable.content.combat.magic.CombatSpellData;
import io.sable.content.combat.melee.QuickPrayers;
import io.sable.content.combat.stats.BossTimers;
import io.sable.content.combat.stats.NPCDeathTracker;
import io.sable.content.combat.pvp.Killstreak;
import io.sable.content.event.eventcalendar.EventCalendar;
import io.sable.content.event.eventcalendar.EventChallenge;
import io.sable.content.item.lootable.impl.VoteMysteryBox;
import io.sable.content.item.lootable.impl.NormalMysteryBox;
import io.sable.content.item.lootable.impl.PvmCasket;
import io.sable.content.item.lootable.impl.SuperMysteryBox;
import io.sable.content.item.lootable.impl.UltraMysteryBox;
import io.sable.content.item.lootable.unref.CoinBagLarge;
import io.sable.content.item.lootable.unref.CoinBagMedium;
import io.sable.content.item.lootable.unref.CoinBagSmall;
import io.sable.content.item.lootable.unref.DailyGearBox;
import io.sable.content.item.lootable.unref.DailySkillBox;
import io.sable.content.items.Degrade;
import io.sable.content.items.pouch.GemBag;
import io.sable.content.items.pouch.HerbSack;
import io.sable.content.items.pouch.RunePouch;
import io.sable.content.lootbag.LootingBag;
import io.sable.content.minigames.bounty_hunter.BountyHunter;
import io.sable.content.minigames.fight_cave.FightCave;
import io.sable.content.minigames.inferno.Inferno;
import io.sable.content.minigames.pest_control.PestControl;
import io.sable.content.minigames.pest_control.PestControlRewards;
import io.sable.content.minigames.pk_arena.Highpkarena;
import io.sable.content.minigames.pk_arena.Lowpkarena;
import io.sable.content.minigames.raids.RaidConstants;
import io.sable.content.minigames.warriors_guild.WarriorsGuild;
import io.sable.content.minigames.xeric.XericLobby;
import io.sable.content.polls.PollTab;
import io.sable.content.preset.Preset;
import io.sable.content.prestige.PrestigeSkills;
import io.sable.content.skills.Agility;
import io.sable.content.skills.ExpLock;
import io.sable.content.skills.SkillInterfaces;
import io.sable.content.skills.agility.AgilityHandler;
import io.sable.content.skills.agility.impl.BarbarianAgility;
import io.sable.content.skills.agility.impl.GnomeAgility;
import io.sable.content.skills.agility.impl.Lighthouse;
import io.sable.content.skills.agility.impl.Shortcuts;
import io.sable.content.skills.agility.impl.WildernessAgility;
import io.sable.content.skills.agility.impl.rooftop.RooftopAlkharid;
import io.sable.content.skills.agility.impl.rooftop.RooftopCanafis;
import io.sable.content.skills.agility.impl.rooftop.RooftopDraynor;
import io.sable.content.skills.agility.impl.rooftop.RooftopFalador;
import io.sable.content.skills.agility.impl.rooftop.RooftopPollnivneach;
import io.sable.content.skills.agility.impl.rooftop.RooftopRellekka;
import io.sable.content.skills.farming.Farming;
import io.sable.content.skills.fletching.Fletching;
import io.sable.content.skills.herblore.Herblore;
import io.sable.content.skills.hunter.Hunter;
import io.sable.content.skills.mining.Mining;
import io.sable.content.skills.prayer.Prayer;
import io.sable.content.skills.slayer.Slayer;
import io.sable.content.skills.smithing.Smelting;
import io.sable.content.skills.smithing.Smithing;
import io.sable.content.skills.smithing.SmithingInterface;
import io.sable.content.skills.thieving.Thieving;
import io.sable.content.titles.Titles;
import io.sable.content.tournaments.TourneyManager;
import io.sable.content.trails.TreasureTrails;
...
import io.sable.model.entity.player.mode.Mode;
import io.sable.model.entity.player.mode.ModeType;
import io.sable.model.entity.player.mode.RegularMode;
import io.sable.model.items.bank.Bank;
import io.sable.model.items.bank.BankPin;
import io.sable.model.lobby.LobbyManager;
import io.sable.model.lobby.LobbyType;
...
import io.sable.model.multiplayersession.duel.Duel;
import io.sable.model.multiplayersession.duel.DuelSession;
import io.sable.model.multiplayersession.trade.Trade;
import io.sable.model.shops.ShopAssistant;
import io.sable.model.world.Clan;
import io.sable.net.Packet;
import io.sable.net.login.LoginReturnCode;
import io.sable.net.login.RS2LoginProtocol;
import io.sable.net.outgoing.UnnecessaryPacketDropper;
import io.sable.sql.etc.HiscoresUpdateQuery;
import io.sable.sql.outlast.OutlastLeaderboardAdd;
import io.sable.util.ISAACCipher;
import io.sable.util.Misc;
import io.sable.util.Stopwatch;
import io.sable.util.Stream;
import io.sable.util.discord.Discord;
import io.sable.util.logging.player.ChangeAddressLog;
import io.sable.util.logging.player.ConnectionLog;
...
public class Player extends Entity {
    ...
    public io.sable.content.preset.Set lastPreset;
    ...
    private final Queue<io.sable.net.Packet> queuedPackets = new ConcurrentLinkedQueue<>();
    ...
    public void flushOutStream() {
        ...
        io.sable.net.Packet packet = new io.sable.net.Packet(-1, io.sable.net.Packet.Type.FIXED, Unpooled.wrappedBuffer(temp));
