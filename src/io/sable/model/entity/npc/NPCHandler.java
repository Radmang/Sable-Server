package io.sable.model.entity.npc;
...
import io.sable.content.achievement_diary.AchievementDiaryKills;
...
import io.sable.content.bosses.wildypursuit.FragmentOfSeren;
import io.sable.content.bosses.wildypursuit.TheUnbearable;
...
import io.sable.content.combat.formula.rework.MagicCombatFormula;
import io.sable.content.combat.formula.rework.RangeCombatFormula;
import io.sable.content.combat.melee.MeleeExtras;
import io.sable.content.instances.InstancedArea;
import io.sable.content.minigames.barrows.brothers.Brother;
import io.sable.content.minigames.fight_cave.Wave;
import io.sable.content.minigames.inferno.InfernoWaveData;
import io.sable.content.minigames.pest_control.PestControl;
import io.sable.content.minigames.xeric.XericWave;
import io.sable.content.questing.hftd.DagannothMother;
import io.sable.content.skills.hunter.impling.PuroPuro;
...
import io.sable.model.entity.npc.actions.LoadSpell;
import io.sable.model.entity.npc.data.AttackAnimation;
...
public class NPCHandler {
    ...
    public static boolean isFightCaveNpc(NPC npc) {
        ...
        switch (npc.getNpcId()) {
        case io.sable.content.minigames.fight_cave.Wave.TZ_KEK_SPAWN:
        case io.sable.content.minigames.fight_cave.Wave.TZ_KIH:
        case io.sable.content.minigames.fight_cave.Wave.TZ_KEK:
        case io.sable.content.minigames.fight_cave.Wave.TOK_XIL:
        case io.sable.content.minigames.fight_cave.Wave.YT_MEJKOT:
        case io.sable.content.minigames.fight_cave.Wave.KET_ZEK:
        case Wave.TZTOK_JAD: 
            return true;
        }
        return false;
